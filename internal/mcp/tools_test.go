...
func TestMCPPathResolutionMatchesCLIResolverWithPlatformDefaults(t *testing.T) {
	...
	if want := filepath.Join(home, ".config", "nowshowing-pp-cli", "config.toml"); cfg.Path != want {
	...
	if want := filepath.Join(home, ".local", "share", "nowshowing-pp-cli", "data.db"); gotDB != want {
...
func resetMCPPathEnv(t *testing.T) string {
	...
	for _, name := range []string{
		"NOWSHOWING_CONFIG",
		"NOWSHOWING_CONFIG_DIR",
		"NOWSHOWING_DATA_DIR",
		"NOWSHOWING_STATE_DIR",
		"NOWSHOWING_CACHE_DIR",
		"NOWSHOWING_HOME",
		"XDG_CONFIG_HOME",
		"XDG_DATA_HOME",
		"XDG_STATE_HOME",
...
func TestMCPRegisterToolsPreservesTypedSpecialTools(t *testing.T) {
	s := server.NewMCPServer("nowshowing", "test")
	RegisterTools(s)
