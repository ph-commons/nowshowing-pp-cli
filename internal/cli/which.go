...
var whichIndex = []whichEntry{
	{Command: "now-playing", Description: "Every movie showing today across all tracked Metro Manila and Iloilo cinemas, in one call.", Group: "Cross-theater aggregation", WhyItMatters: "Reach for this to answer 'what's showing today near me' without querying each cinema separately."},
	{Command: "search", Description: "Find which tracked theaters are playing a given movie today, and at what times.", Group: "Cross-theater aggregation", WhyItMatters: "Reach for this when the user names a movie and wants to know where to watch it."},
	{Command: "now-playing", Description: "Flags each showtime as verified (two sources agree), partial, mismatched, or ClickTheCity-only by cross-checking popcorn.app.", Group: "Source confidence", WhyItMatters: "Reach for this when showtime accuracy matters and a single listing site can't be trusted alone."},
	{Command: "movies imdb", Description: "Resolves a movie title to its IMDb page, flagging remake/re-release title collisions by recent year.", Group: "Enrichment", WhyItMatters: "Reach for this to enrich a showtime listing with the correct IMDb link, not a decades-old namesake."},
	{Command: "theaters", Description: "Lists every tracked cinema with its ClickTheCity slug, display name, and city.", Group: "Cross-theater aggregation", WhyItMatters: "Reach for this to discover valid --slug / --theater values before querying schedules."},
}
...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  nowshowing-pp-cli which "stale tickets"
  nowshowing-pp-cli which "bottleneck"
  nowshowing-pp-cli which --limit 1 "send message"
  nowshowing-pp-cli which                                # list the full capability index`,
