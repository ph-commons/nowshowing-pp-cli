...
func withTempLearnHome(t *testing.T) string {
	...
	t.Setenv("NOWSHOWING_STATE_DIR", "")
	t.Setenv("NOWSHOWING_HOME", "")
...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"nowshowing-pp-cli auth login",
		"nowshowing-pp-cli doctor",
		"nowshowing-pp-cli help items",
		"nowshowing-pp-cli sync",
		"nowshowing-pp-cli profile list",
		"nowshowing-pp-cli feedback list",
		"nowshowing-pp-cli which",
		"nowshowing-pp-cli agent-context",
		"nowshowing-pp-cli completion bash",
		"nowshowing-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		...
		"nowshowing-pp-cli recall",
		"nowshowing-pp-cli learnings",
		"nowshowing-pp-cli teach-pattern",
		"nowshowing-pp-cli teach-lookup",
		"nowshowing-pp-cli items list",
	}
...
func TestSkipLearnHook_FrameworkCommandsDoNotCreateDefaultDB(t *testing.T) {
	...
	for _, args := range cases {
		...
		if _, err := os.Stat(defaultDBPath("nowshowing-pp-cli")); err == nil {
